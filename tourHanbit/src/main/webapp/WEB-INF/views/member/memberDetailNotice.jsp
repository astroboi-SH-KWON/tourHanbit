...
<h2>게시물 상세</h2>
	...
	<button onclick="location.href='memberUpdateNotice.do?notice_number=${n.notice_number}'" class="btn btn-info">수정</button>
	</span>
	<span style="padding-right: 0px; float: right">
	<button onclick="location.href='memberDeleteNotice.do?notice_number=${n.notice_number}'" class="btn btn-info">삭제</button>
	</span>
	<br>
	<div style="padding-top:10px;padding-left: 400px">
	<button onclick="location.href='memberListNotice.do'" class="btn btn-info">목록</button>
	</div>
	</div>
</body>
</html>