...
<tr>
<th>주문 번호</th><th>상품명</th><th>가격</th><th>주문일</th><th>진행상황</th><th>예약 확인/예약 취소</th>
</tr>
...
<td>${pd.orderdate }</td>
<td></td>
<td><center><a href="memberMypagedelete.do?orderid=${pd.orderid }">취소</a></center></td>
</tr>
</c:forEach> --%>
</table>
<hr>
...
<tr><td><h3>추천 상품</h3></td></tr>
<tr>
<th>상품 명</th><th>출발일/도착일</th><th>상품 가격</th>
</tr>
</table>
<hr>
<br>
