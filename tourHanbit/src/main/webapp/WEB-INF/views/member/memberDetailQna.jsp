...
<script type="text/javascript">
	function listReply() {
		...
		$("#reply").empty();
		$.getJSON("/tourapp/memberListReply.do", function(data) {
...
<body>
	...
	<button onclick="location.href='memberUpdateQna.do?qna_number=${q.qna_number}'" class="btn btn-info">수정</button>
	</span>
	<span style="padding-right: 0px; float: right">
	<button onclick="location.href='memberDeleteQna.do?qna_number=${q.qna_number}'" class="btn btn-info">삭제</button>
	</span>
	<br>
	...
	<button onclick="location.href='memberListQna.do'" class="btn btn-info">목록</button>
	</div>
	</div>
