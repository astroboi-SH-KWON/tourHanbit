...
<table border="1">
	<tr>
		<td>아이디</td>
		<td><input type="text" value="${mem_update_ready.mem_id }" name="mem_id" readonly="readonly"></td>
		<td></td>
	</tr>
	<tr>
		<td>비밀번호</td>
		<td><input type="password" name="mem_pwd" id="mem_pwd" value="${mem_update_ready.mem_pwd }"></td>
		<td></td>
	</tr>
	<tr>
		<td>비밀번호 확인</td>
		<td><input type="password" name="mem_pwdcheck" id="mem_pwdcheck" value="${mem_update_ready.mem_pwd }"></td>
		<td></td>
	</tr>
	<tr>
		<td>이름</td>
		<td><input type="text" value="${mem_update_ready.mem_name }" name="mem_name" readonly="readonly"></input></td>
		<td></td>
	</tr>
	<tr>
		<td>이메일</td>
